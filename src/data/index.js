...
const portfolio = [
    ...
    // },
    {
        name: "Abarta AI",
        description:
            "GPT4-turbo for Irish students: syllabus chatbot, paper helper, vision-based grader, study buddy.",
        image: abarta,
    },
    {
        name: "Dr Life",
        description:
            "Mental health app: therapy chatbot, mood tracker, journal, meditation helper, calendar.",
        image: drlife,
    },
];
